...
namespace MinimumSpanningTreeApp
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeGraphData()
        {
            ...
            {
                ("A", "C", 5), // Edge from A to C with weight 5
                ("C", "B", 7), // Edge from C to B with weight 7
                ("B", "E", 2), // Edge from B to E with weight 2
                ("E", "D", 1), // Edge from E to D with weight 1
                ("D", "C", 1), // Edge from D to C with weight 1
            };
        }
